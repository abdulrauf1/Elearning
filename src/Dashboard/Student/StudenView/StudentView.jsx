        ...
        <>
            ...
            <div className={classes.teacherView}>
                <div className="colLeft">
                    <h2 className={classes.title}>Student Details</h2>
                ...
                <div className={classes.tView}>
                    ...
                    <p className="mt-1 text-secondary fs-5">Hello I am Daisy Parks. Lorem Ipsum is simply dummy text of the printing and typesetting industry, simply dummy text of the printing and typesetting industry.</p>
